...
public class RouteMController {
    ...
    public LinkedList<RouteMModel> loadRoutes(String routesFilePath) {
        // Crear una instancia de FileJsonAdapter para rutas
        FileJsonAdapter<RouteMModel> routeJsonAdapter = FileJsonAdapter.getInstance();
    
        // Leer los datos del archivo JSON y establecer la lista de rutas en el controlador de rutas
        LinkedList<RouteMModel> routeList = routeJsonAdapter.getObjects(routesFilePath, RouteMModel[].class);
...
// Método para obtener la lista de rutas
public LinkedList<RouteMModel> getRoutes() {
    ...
    public void assignTrainToRoute(String trainIdentifier, String routeName, String points, int distance) {
        ...
        RouteMModel route = new RouteMModel(routeName, train, points, distance);
    ...
    public static void main(String[] args) {
        RouteMController controller = new RouteMController();
