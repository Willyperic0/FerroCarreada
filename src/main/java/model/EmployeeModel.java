...
public class EmployeeModel extends Person implements Serializable {
    ...
    // Constructor sin parámetros que llama al constructor de la superclase Person con valores por defecto y establece el nombre de usuario y contraseña como cadenas vacías
